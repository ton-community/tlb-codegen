...
import {
    ...
    LessThan,
    LoadFromNegationOutsideExpr,
    ManyComb,
    MathExprAsCombArg,
    MultipleEmptyConstructor,
    NegationFromImplicit,
    OneComb,
    ParamConst,
    ParamDifNames,
    ParamDifNamesUser,
    ParamNamedArgInSecondConstr,
    RefCombinatorAny,
    RefCombinatorInRef,
    SharpConstructor,
    SharpTag,
    ...
    loadComplexTypedField,
    loadConditionalField,
    loadConditionalRef,
    loadConstructorOrder,
    loadDollarTag,
    loadEmptyTag,
    loadEqualityExpression,
    loadExprArgUser,
    loadExtAddressUser,
    loadFalseAnonField,
    loadGramsUser,
    loadHashmapAugEUser,
    loadHashmapEUser,
    loadHashmapExprKeyUser,
    loadHashmapOneCombUser,
    loadHashmapTPCell,
    loadHashmapVUIUser,
    loadHashmapVarKeyUser,
    loadImplicitCondition,
    loadIntBitsOutside,
    loadIntBitsParametrizedOutside,
    loadLessThan,
    loadLoadFromNegationOutsideExpr,
    loadManyComb,
    loadMathExprAsCombArg,
    loadMultipleEmptyConstructor,
    loadNegationFromImplicit,
    loadParamConst,
    loadParamDifNames,
    loadParamDifNamesUser,
    loadParamNamedArgInSecondConstr,
    loadRefCombinatorAny,
    loadRefCombinatorInRef,
    loadSharpConstructor,
    loadSharpTag,
    loadSimple,
    loadTrue,
    loadTupleCheck,
    ...
    storeCheckCrc32,
    storeCheckKeyword,
    storeCombArgCellRefUser,
    storeComplexTypedField,
    storeConditionalField,
    storeConditionalRef,
    storeConstructorOrder,
    storeDollarTag,
    storeEmptyTag,
    storeEqualityExpression,
    storeExprArgUser,
    storeExtAddressUser,
    storeFalseAnonField,
    storeGramsUser,
    storeHashmapAugEUser,
    storeHashmapEUser,
    storeHashmapExprKeyUser,
    storeHashmapOneCombUser,
    storeHashmapTPCell,
    storeHashmapVUIUser,
    storeHashmapVarKeyUser,
    storeImplicitCondition,
    storeIntBitsOutside,
    storeIntBitsParametrizedOutside,
    storeLessThan,
    storeLoadFromNegationOutsideExpr,
    storeManyComb,
    storeMathExprAsCombArg,
    storeMultipleEmptyConstructor,
    storeNegationFromImplicit,
    storeParamConst,
    storeParamDifNames,
    storeParamDifNamesUser,
    storeParamNamedArgInSecondConstr,
    storeRefCombinatorAny,
    storeRefCombinatorInRef,
    storeSharpConstructor,
    storeSharpTag,
    storeSimple,
    storeTrue,
    storeTupleCheck,
    ...
    storeTypedParam,
    storeUnary,
    storeUnaryUserCheckOrder,
    storeVMStackUser,
    storeVarIntegerUser,
    storeVarUIntegerUser,
    CheckCrc32_a,
    CheckCrc32_b,
    TagCalculatorExample,
...
describe('Generating tlb code', () => {
    ...
    test('Basic types', () => {
        ...
        let typedParamValue: TypedParam = {
            kind: 'TypedParam',
            x: { kind: 'Maybe_just', value: { kind: 'SharpConstructor', c: 5, y: { kind: 'FixedIntParam', y: 6 } } },
        };
        ...
        let bitlenArgUserIncorrect: BitLenArgUser = {
            kind: 'BitLenArgUser',
            t: { kind: 'BitLenArg', x: 3, value: BigInt(10) },
        };
        ...
        let exprArgUserIncorrect: ExprArgUser = {
            kind: 'ExprArgUser',
            t: { kind: 'ExprArg', x: 5, value: BigInt(10) },
        };
        checkDifferOnStoreLoad(exprArgUserIncorrect, loadExprArgUser, storeExprArgUser);
        let complexTypedField: ComplexTypedField = {
            kind: 'ComplexTypedField',
            a: { kind: 'ExprArgUser', t: { kind: 'ExprArg', x: 4, value: BigInt(10) } },
        };
        checkSameOnStoreLoad(complexTypedField, loadComplexTypedField, storeComplexTypedField);
        let cellTypedField: CellTypedField = {
            kind: 'CellTypedField',
            a: { kind: 'ExprArgUser', t: { kind: 'ExprArg', x: 4, value: BigInt(10) } },
        };
        ...
        checkSameOnStoreLoad(
            paramNamedArgInSecondConstr,
            (slice: Slice) => {
                return loadParamNamedArgInSecondConstr(slice, 3);
            },
            storeParamNamedArgInSecondConstr,
        );
        ...
        let checkBigInt: BitLenArg = {
            kind: 'BitLenArg',
            x: 100,
            value: BigInt(2709958555) * BigInt(1e9) + BigInt(228628813),
        };
        checkSameOnStoreLoad(
            checkBigInt,
            (slice: Slice) => {
                return loadBitLenArg(slice, checkBigInt.x);
            },
            storeBitLenArg,
        );
    });
    ...
    test('Primitives', () => {
        ...
        let expectedAddressUser: AddressUser = {
            kind: 'AddressUser',
            src: Address.parseFriendly('EQBmzW4wYlFW0tiBgj5sP1CgSlLdYs-VpjPWM7oPYPYWQEdT').address,
        };
        ...
        let extAddressUser: ExtAddressUser = {
            kind: 'ExtAddressUser',
            src: new ExternalAddress(BigInt(5623048054), 48),
        };
        ...
        tpcDict.set(BigInt(5), {
            kind: 'TypedParam',
            x: { kind: 'Maybe_just', value: { kind: 'SharpConstructor', c: 3, y: { kind: 'FixedIntParam', y: 4 } } },
        });
        tpcDict.set(BigInt(3), {
            kind: 'TypedParam',
            x: { kind: 'Maybe_just', value: { kind: 'SharpConstructor', c: 9, y: { kind: 'FixedIntParam', y: 8 } } },
        });
        ...
        let hashmapVarKeyUser: HashmapVarKeyUser = {
            kind: 'HashmapVarKeyUser',
            x: { kind: 'HashmapVarKey', n: 5, x: vkDict },
        };
        ...
        let hashmapExprKeyUser: HashmapExprKeyUser = {
            ...
            x: { kind: 'HashmapExprKey', n: 5, x: vkDict },
        };
        ...
        let hashmapOneCombUser: HashmapOneCombUser = {
            kind: 'HashmapOneCombUser',
            x: { kind: 'HashmapOneComb', x: ocuDict },
        };
    ...
    test('Combinators', () => {
        ...
        let mathExprAsCombArg: MathExprAsCombArg = {
            kind: 'MathExprAsCombArg',
            n: 8,
            ref: { kind: 'BitLenArg', x: 10, value: BigInt(1000) },
        };
        checkSameOnStoreLoad(
            mathExprAsCombArg,
            (slice: Slice) => {
                return loadMathExprAsCombArg(slice, mathExprAsCombArg.n + 2);
            },
            storeMathExprAsCombArg,
        );
        ...
        let msgEnvelope: RefCombinatorInRef = {
    ...
    test('Advanced types', () => {
        ...
        let paramDifNamesC: ParamDifNames = {
            kind: 'ParamDifNames_c',
            n: 3,
            x: { kind: 'ParamDifNames_c', n: 2, x: { kind: 'ParamDifNames_c', n: 1, x: { kind: 'ParamDifNames_a' } } },
        };
        checkSameOnStoreLoad(paramDifNamesC, (slice: Slice) => loadParamDifNames(slice, 2), storeParamDifNames);
        let paramDifNamesD: ParamDifNames = {
            kind: 'ParamDifNames_d',
            m: 4,
            x: { kind: 'ParamDifNames_d', m: 2, x: { kind: 'ParamDifNames_d', m: 1, x: { kind: 'ParamDifNames_b' } } },
        };
        checkSameOnStoreLoad(paramDifNamesD, (slice: Slice) => loadParamDifNames(slice, 3), storeParamDifNames);

        let paramDifNamesUser: ParamDifNamesUser = {
        ...
        let paramDifNamesUserIncorrect: ParamDifNamesUser = {
            kind: 'ParamDifNamesUser',
            k: 5,
            x: {
                kind: 'ParamDifNames_c',
        ...
        let unaryUserCheckOrder: UnaryUserCheckOrder = {
        ...
        let loadFromNegationOutsideExpr: LoadFromNegationOutsideExpr = {
    ...
    test('Slices', () => {
        ...
        checkDifferOnStoreLoad(
            intBitsParametrizedOutsideIncorrect,
            loadIntBitsParametrizedOutside,
            storeIntBitsParametrizedOutside,
        );
    });
