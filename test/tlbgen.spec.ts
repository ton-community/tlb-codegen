...
describe('Generating tlb code', () => {
    ...
    test('Primitives', () => {
        ...
        let coinsUser: CoinsUser = { kind: 'CoinsUser', coins: BigInt(100000) };
        checkSameOnStoreLoad(coinsUser, loadCoinsUser, storeCoinsUser);
    })
